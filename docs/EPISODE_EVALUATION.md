...
- 排除内部版本号后的实质状态变化种类；
- 物品归属、角色/物品出现消失、义务与 Agreement 生命周期等不可逆变化；
